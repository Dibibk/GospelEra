              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-white text-sm font-medium bg-white/10 backdrop-blur-sm rounded-lg px-3 py-2">Share your heart with our community and receive prayer support</p>
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-br from-white via-primary-50/20 to-purple-50/20 shadow-xl rounded-2xl border border-primary-200/50 backdrop-blur-sm mb-8">
          <div className="px-8 py-6 border-b border-gradient-to-r from-primary-200/40 via-purple-200/40 to-primary-200/40">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <h2 className="text-xl font-bold bg-gradient-to-r from-primary-800 to-purple-700 bg-clip-text text-transparent bg-white/60 backdrop-blur-sm rounded-lg px-3 py-2">Search & Discover</h2>
            </div>
          ...
          <div className="px-8 py-6 border-b border-gradient-to-r from-primary-200/40 via-purple-200/40 to-primary-200/40">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <h2 className="text-xl font-bold bg-gradient-to-r from-primary-800 to-purple-700 bg-clip-text text-transparent bg-white/60 backdrop-blur-sm rounded-lg px-3 py-2">
