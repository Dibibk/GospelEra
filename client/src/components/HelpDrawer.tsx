...
export function HelpDrawer({ isOpen, onClose, helpTriggerRef }: HelpDrawerProps) {
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center space-x-3">
            ...
            <h2 id="help-drawer-title" className="text-xl font-semibold text-gray-900 dark:text-white">
              Help & Support
            </h2>
          </div>
          <button
